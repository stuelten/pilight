...
/**
 * Abstract implementation of a {@link de.ckc.agwa.pilight.io.PiLightSensor} with a name.
 *
 * @author Timo Stülten
 */
public abstract class AbstractPiLightSensor implements PiLightSensor {
    /**
     * The logger for this class only.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractPiLightSensor.class);
    ...
    public AbstractPiLightSensor() {
        super();
    }

    public AbstractPiLightSensor(String name) {
        this();
        this.name = name;
    }
